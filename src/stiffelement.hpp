...
void EStiffness :: Compute_Element_Stiffness(){
  double B[3][K_size];
...
//  cout << endl;
  ...
  cblas_dgemm(CblasRowMajor,CblasTrans,CblasNoTrans,K_size,3,3,1.0,&B[0][0],K_size,&C[0][0],3,0.0,&result[0][0],3);
...
//  }
  ...
  cblas_dgemm(CblasRowMajor,CblasNoTrans,CblasNoTrans,K_size,K_size,3,1.0,&result[0][0],3,&B[0][0],K_size,0.0,&K[0][0],K_size);
